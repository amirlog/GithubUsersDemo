...
//get data from view model
        viewModel.user.observe(viewLifecycleOwner, Observer { user ->
            ...
            android.util.Log.i("amir",""+name+" "+bio+" "+image+" "+website+" "+login)
            HomeFragment.Companion.setContext(activity)
    ...
    companion object {
         private var con: FragmentActivity? = null

        fun setContext(c: FragmentActivity?) {
            con = c
        }

        fun showError() {
            var cs : CharSequence = "Wrong Input"
            Toast.makeText(
                con,
                cs,
                Toast.LENGTH_SHORT
